...
<head>
    ...
    <title>Servicios - Cut Club Barbería</title>
    <style>
       * {
            margin: 0;
            padding: 0;
            ...
            <div class="service-card">
                ...
                <div class="service-info">
                  <h3>Corte de Cabello</h3>
                    ...
                    <a href="reservar.jsp?servicio=Corte%20de%20Cabello&precio=25000" class="btn">Reservar</a>
                    
                </div>
            </div>
            <div class="service-card">
                <div class="service-image">
                    <img src="images/Barbas.avif" alt="Corte de Barba" width="170" height="170">
                </div>
                <div class="service-info">
                    <h3>Corte de Barba</h3>
                    <p>Diseño y arreglo de barba con acabado impecable.</p>
                    <div class="price">$20.000</div>
                   <a href="reservar.jsp?servicio=Corte%20de%20barba&precio=20000" class="btn">Reservar</a>
                </div>
            </div>
            <div class="service-card">
                <div class="service-image">
                    <img src="images/limpieza_facial.jpg" alt="Limpieza Facial" width="170" height="170">
                </div>
                <div class="service-info">
                    <h3>Limpieza Facial</h3>
                    <p>Tratamiento completo para una piel limpia y saludable.</p>
                    <div class="price">$30000</div>
                   <a href="reservar.jsp?servicio=Limpieza%20Facial&precio=30000" class="btn">Reservar</a>
                </div>
            </div>
            <div class="service-card">
                <div class="service-image">
                    <img src="images/corte_niño.jpeg" alt="Corte de Niños" width="170" height="170">
                </div>
                <div class="service-info">
                    <h3>Corte de Niños</h3>
                    <p>Corte especializado para los más pequeños.</p>
                    <div class="price">$18000</div>
                   <a href="reservar.jsp?servicio=Corte%20de%20Niños&precio=18000" class="btn">Reservar</a>
                </div>
            </div>
            <div class="service-card">
                <div class="service-image">
                    <img src="images/cejas.jpg" alt="Depilacion de cejas" width="170" height="170">
                </div>
                <div class="service-info">
                    <h3>Depilacion de cejas</h3>
                    <p>Acabado impecable de tus cejas.</p>
                    <div class="price">$12.000</div>
                <a href="reservar.jsp?servicio=Depilacion%20de%20cejas&precio=12.000" class="btn">Reservar</a>
                </div>
            </div>
        </div>
    </div>
